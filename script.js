...
function x(){
    ...
    else if(document.querySelector("#genre").value=="lokbharti"){
        switch(s){
            case 'std9':
                tg("true");
    ...
    else if(document.querySelector("#genre").value=="lokwaani"){
        switch(s){
            case 'std9':
                tg("true");
...
function z(){
    ...
    if(genre=="balbharti")genre="Balbharti Hindi";
    else if(genre=="kumarbharti")genre="Kumarbharti Hindi";
    else if(genre=="lokbharti")genre="Lokbharti Hindi";
    else if(genre=="lokwaani")genre="Lokwaani Hindi";
    else if(genre=="sugambharti")genre="Sugambharti Hindi";
    else if(genre=="sulabhbharti")genre="Sulabhbharti Hindi";
    else if(genre=="yuvakbharti")genre="Yuvakbharti Hindi";
    let m="";
